    ...
    <div className="main_container">
      <div className="main_info_container">
        <div className="info_container">
          ...
          <p>
            ...
            ensuring data security. Connect with similar conditions, share home
            remedies with a rating system, and access specialized doctors based
            on your location. PulsePal – where advanced technology meets
        ...
        <div className="tech-container">
          ...
          <div className="tech">
            ...
            <p>
              ...
              medical conditions, find matches who can relate with them and also
              find doctors/specialist within there regions on such condition.
            </p>
          </div>
          <div className="tech">
            ...
            <h2>React</h2>
            <p>
              PulsePal employes react a frontend framework to power our frontend
              along with typescript enabling better user experience and smoother
              and faster development,updates and feature roll outs giving
      ...
      <div className="more-info-container">
        ...
        <div className="mi-container">
          ...
          <p>
            A culture where innovation and empathy converge to create impactful
            solutions. Team members are driven by a shared commitment to
            improving healthcare outcomes through cutting-edge technology.
          </p>
        </div>
      </div>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        ...
        <div className="testimonial-container">
          <div className="t-container-1">
            <div className="testimonial">
              ...
              <div className="info">
                <p>
                  <b>PulsePal</b> has being awesome so far making it a breeze to
                  keep track of my medical history coupled with guidance have
                  made staying healthy so much more accessible. The
                  user-friendly interface and helpful <b>home remedies</b> keep
                  me on prepared for emergency breakouts. <b>Thank you</b>
                </p>
              </div>
            </div>
            <div className="testimonial">
          ...
          <div className="testimonial-2">
            ...
            <div className="info">
              <p>
                Using it for quite a while now and it had being nice especially
                a <b>beta</b> feature,i heard it can find out what is wrong with
                your just from your
                <b>finger print</b> it is cool can't wait for the roll out,talk
                about <b>a.i in action</b>
              </p>
            </div>
          </div>
        </div>
